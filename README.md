...
| M7 | Regime/structural-break research | **Phases 1-2 implemented** (research-only). `climate-risk m7-phase1` writes leakage-safe structural-break diagnostics under `gold/research/m7/`; `climate-risk m7-phase2` recomputes regimes at historical origins under `gold/research/m7/phase2/`. No production score, scenario engine, Azure schedule, or publish contract change. See ADR 0011, ADR 0012, and `docs/m7_phase1_report.md`. |
